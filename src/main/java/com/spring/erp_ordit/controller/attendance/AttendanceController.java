...
public class AttendanceController {
	...
	// [ 기본사항등록 ] - 근태 항목 등록 리스트 ⇒ http://localhost:8081/attendance/regAttItems
	...
	// [ 기본사항등록 ] - 근태 항목 등록(Post) ⇒  http://localhost:8081/attendance/addAttItems
	...
	// [ 기본사항등록 ] - 근태 항목 삭제(Delete) ⇒ http://localhost:8081/attendance/deleteAttItems/30008
...
//	    return new ResponseEntity<> (service.deleteAttItems(a_code), HttpStatus.OK);  // 삭제 결과 (1: 성공, 0: 실패)
	...
	// [ 기본사항등록 ] - 근태 항목 수정(Put) ⇒ http://localhost:8081/attendance/updateAttItems/a_code
