...
import com.spring.erp_ordit.dao.basic.BasicItemMapper;
import com.spring.erp_ordit.dto.basic.BaiscItemDTO;

@Service
public class BasicItemServiceImpl {

	@Autowired
	private BasicItemMapper basicItemMapper;
	
	// 거래처 목록
	@Transactional
	public List<BaiscItemDTO> basicItemList() {
		
		return basicItemMapper.basicItemList();
	}
