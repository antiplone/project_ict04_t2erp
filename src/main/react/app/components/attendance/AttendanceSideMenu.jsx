...
// app/components/AttSideMenu.jsx
      ...
      <Sidenav expanded={expand} defaultOpenKeys={["1"]} appearance="subtle">
        <Sidenav.Body>
          <Nav defaultActiveKey="1">
            <Nav.Menu eventKey="1" trigger="hover" title="기본항목등록" placement="rightStart">
            ...
            <Nav.Menu eventKey="2" trigger="hover" title="근태" placement="rightStart">
              <Nav.Item eventKey="2-1">근태</Nav.Item>
              <Nav.Item eventKey="2-2">근태현황</Nav.Item>
            </Nav.Menu>
            <Nav.Menu eventKey="3" trigger="hover" title="출/퇴근" placement="rightStart">
              <Nav.Item eventKey="3-1">출/퇴근반영기준</Nav.Item>
              <Nav.Item eventKey="3-2">출/퇴근기록부</Nav.Item>
              <Nav.Item eventKey="3-3">출/퇴근현황</Nav.Item>
              <Nav.Item eventKey="3-4">지각현황</Nav.Item>
              <Nav.Item eventKey="3-5">출퇴근/근태현황</Nav.Item>
            </Nav.Menu>
          </Nav>
        </Sidenav.Body>
      </Sidenav>
