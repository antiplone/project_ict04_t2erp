...
export default function BuySelectTabCheck({ rowState }) {
...
//							console.log("res :", res);
    ...
    }, [rowData]); // []은 디펜던시인데, setState()로 렌더링될때 실행되면 안되고, 1번만 실행하도록 빈배열을 넣어둔다.
            ...
            <Table height={500} data={buyOrderCheckList}>
                ...
                <Column width={150} className='text_center'>
                    ...
                    <Cell>
                        {(orderDate) => (
                            <span
                                onClick={() => buyOrderCheckList(orderDate.order_id)}
                            >
