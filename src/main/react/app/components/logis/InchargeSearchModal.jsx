...
const InchargeSearchModal = ({ title = " 담당자 검색 " , confirm = " 확인 ", cancel = " 취소 ", onInchargeSelect, handleOpen, handleColse } /* = props:속성 */) => {
	...
	return (
		<Modal open={handleOpen} onClose={handleColse} size="xs">
			...
			<Modal.Footer>
				...
				<Button onClick={() => setSelectedIncharge(null)} appearance="ghost" color="orange">
					초기화
				</Button>
