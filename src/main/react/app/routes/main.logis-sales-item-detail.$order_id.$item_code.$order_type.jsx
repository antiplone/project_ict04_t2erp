    ...
    return (
        <div>
			...
			<Container style={{fontSize:'16px'}}>
				...
				<Table height={100} width={1480} data={salesItemDetail ? [salesItemDetail] : []} onRowClick={OrderData => console.log(OrderData)} style={{margin: '0 auto'}}>
					...
					<Column width={180} className="text_center" >
						<HeaderCell style={{fontSize:'16px'}}>출하요청일</HeaderCell>
