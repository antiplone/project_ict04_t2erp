import { Button, Message, Divider, Table, toaster, Container, Placeholder, Loader } from 'rsuite';
...
const sell_all_list_detail = () => {
    ...
    <div className="sell_DetailBtnBox">
      <Button
        appearance="ghost"
        color="blue"
        className="sell_DetailBtn"
        onClick={() => updateAllList(order_id)}
      >
        수정
      </Button>
      <Button
        style={{ marginRight: 10, border: "1px solid #22284C", color: "#22284C" }}
        appearance="ghost"
        className="sell_DetailBtn"
        onClick={() => allList()}
      >
      ...
      <Button
        ...
        color="red"
        className="sell_DetailBtn"
        onClick={() => deleteAllList(order_id)}
      >
        삭제
      </Button>
    </div>
